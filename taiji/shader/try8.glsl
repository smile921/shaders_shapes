...
void main(){
    ...
    float radius =0.2;
    float mv = 0.22444445;
    vec2 point2 = vec2(st.x + mv,st.y);
	vec3 color2 = vec3(circle(point2,radius));
    ...
    float hlf7 = step(0.5,1.-st.y);
    vec3 color8 = vec3(hlf7);
    color7 = color7 +color8;
    color7 = step(0.5,color7);
 
    float radius8 =0.8;
    float mv8 = 0.0;
    vec2 point8 = vec2(st.x + mv8,st.y);
	vec3 color9 = vec3(circle(point8,radius8));
    color7 = color9 - 0.2 + color7;
    color7 = vec3(0.2471, 0.0863, 0.9529) - step(0.9,color7);
    color = color  + color + color7;
